            ...
            <div className="flex items-center justify-between text-sm max-w-full mx-auto px-2">
                <div className="flex items-center min-w-0">
                    ...
                    <div className="ml-2 min-w-0">
                        <span className="font-semibold text-primary-800 dark:text-primary-200">{message.author.name}</span>
                        <span className="text-gray-600 dark:text-gray-300 ml-1 truncate">: {message.text}</span>
                    </div>
                </div>
                <button onClick={() => onUnpin(message.id)} className="p-1 rounded-full hover:bg-primary-100 dark:hover:bg-primary-800/60 flex-shrink-0 ml-2">
