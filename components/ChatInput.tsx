      ...
      <div className="flex-shrink-0 p-2 md:p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex justify-between items-center mb-2 px-3 py-1.5 bg-blue-100 dark:bg-blue-900/50 rounded-lg">
            <div>
              <p className="text-sm font-semibold text-blue-600 dark:text-blue-400">
                Replying to {replyingMessage.author.name}
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400 truncate">
        ...
        {attachedFiles.length > 0 && (
          <div className="mb-2 space-y-2">
            {attachedFiles.map((file, index) => (
              <div
                key={index}
                className="flex justify-between items-center px-3 py-1.5 bg-gray-100 dark:bg-gray-700/50 rounded-lg"
              >
                <div>
                  <p className="text-sm font-semibold text-primary-600 dark:text-primary-400">
                    File Attached
        ...
        <div className="flex items-end gap-2">
          ...
          <button
            ...
            className={`p-2 rounded-full transition-colors ${isRecording ? 'bg-red-500 text-white animate-pulse' : 'text-gray-500 hover:bg-gray-200 dark:hover:bg-gray-700 dark:text-gray-400'} disabled:opacity-50`}
          >
          ...
          <button
            ...
            className="p-2.5 text-white bg-primary-600 rounded-full hover:bg-primary-700 disabled:bg-primary-300 dark:disabled:bg-primary-800 transition-colors"
          >
