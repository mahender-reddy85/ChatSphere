    ...
    >
      ...
      >
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 mt-1 text-sm font-medium text-white bg-primary-600 rounded-md hover:bg-primary-700 min-w-[110px] justify-center"
              >
                <IconShare className="w-4 h-4" /> {copyStatus}
              </button>
              <button
                onClick={handleShareReferral}
                className="flex items-center gap-2 px-3 py-2 mt-1 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-700 min-w-[80px] justify-center"
                title="Share via WhatsApp, etc."
              >
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-800/50 border-t dark:border-gray-700 flex justify-between items-center">
          <button
            onClick={logout}
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-red-600 rounded-md hover:bg-red-100 dark:hover:bg-red-900/50"
          >
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium text-white rounded-md min-w-[120px] transition-colors ${
              isSaved ? 'bg-green-600 hover:bg-green-700' : 'bg-primary-600 hover:bg-primary-700'
            }`}
          >
