...
export const IconAI: React.FC<IconProps> = (props) => (
  <svg {...props} width="200" height="250" viewBox="0 0 150 200" xmlns="http://www.w3.org/2000/svg">
    <circle cx="75" cy="50" r="25" fill="#00BCD4"/>
    <circle cx="65" cy="45" r="5" fill="#fff"/>
    <circle cx="85" cy="45" r="5" fill="#fff"/>
    <line x1="60" y1="30" x2="50" y2="10" stroke="#00BCD4" stroke-width="3"/>
    <line x1="90" y1="30" x2="100" y2="10" stroke="#00BCD4" stroke-width="3"/>
    <rect x="50" y="75" width="50" height="70" rx="25" ry="25" fill="#009688"/>
  </svg>
);
...
export const IconPoll: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconVideoOff: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconPhoneOff: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81 .7 2 2 0 0 1 1.72 2.05v1.59a2 2 0 0 1-2.18 2.18a19.79 19.79 0 0 1-8.63-3.07a19.42 19.42 0 0 1-3.33-2.67a19.79 19.79 0 0 1-3.07-8.63A2 2 0 0 1 4.11 2h1.59a2 2 0 0 1 2.05 1.72a12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91"></path><line x1="23" y1="1" x2="1" y2="23"></line>
  </svg>
);

export const IconScreenShare: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconDoubleCheck: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <polyline points="20 6 9 17 4 12" />
        <polyline points="20 6 9 17 4 12" transform="translate(4, 4)" />
    </svg>
);
