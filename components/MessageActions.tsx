    ...
    <div className="relative flex items-center" ref={menuRef}>
      <div className="absolute right-full top-1/2 -translate-y-1/2 mr-2 md:group-hover:opacity-100 md:opacity-0 opacity-100 transition-opacity flex items-center gap-1 bg-gray-200 dark:bg-gray-600 p-1 rounded-full">
        <button
          ...
          className="p-1 rounded-full hover:bg-gray-300 dark:hover:bg-gray-500 touch-manipulation"
        >
      ...
      {isMenuOpen && (
        <div className="absolute top-full right-0 mt-2 w-48 bg-white dark:bg-gray-700 rounded-lg shadow-lg border dark:border-gray-600 p-2 z-10">
          <button
            onClick={handleCopy}
            className="w-full text-left flex items-center gap-2 px-3 py-1.5 rounded hover:bg-gray-100 dark:hover:bg-gray-600 text-sm"
          >
          ...
          {isCurrentUserMessage && (
            <>
              ...
              <button
                ...
                className="w-full text-left flex items-center gap-2 px-3 py-1.5 rounded hover:bg-gray-100 dark:hover:bg-gray-600 text-sm text-red-600 dark:text-red-400"
              >
      ...
      {isDeleteMenuOpen && (
        <div className="absolute top-full right-0 mt-2 w-48 bg-white dark:bg-gray-700 rounded-lg shadow-lg border dark:border-gray-600 p-2 z-10">
          ...
          <button
            ...
            className="w-full text-left flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600 text-sm"
          >
            <IconTrash className="w-4 h-4" /> Delete for me
          </button>
          <button
            onClick={handleDeleteForEveryone}
            className="w-full text-left flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600 text-sm text-red-600 dark:text-red-400"
          >
