      ...
      <div className="flex items-center justify-between mt-2 text-xs text-gray-600 dark:text-gray-400">
        ...
        <div className="flex items-center border rounded-lg dark:border-gray-600 p-0.5">
          <button
            ...
            disabled={disabled}
            className={`px-2 py-0.5 rounded-md text-xs ${scope === 'current' ? 'bg-primary-500 text-white' : ''} disabled:opacity-50`}
          >
            Current
          </button>
          <button
            ...
            className={`px-2 py-0.5 rounded-md text-xs ${scope === 'all' ? 'bg-primary-500 text-white' : ''}`}
          >
            All Chats
          </button>
        </div>
