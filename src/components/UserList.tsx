    ...
    <div className="flex-grow flex flex-col min-h-0">
      <div className="flex justify-between items-center px-4 pt-4 mb-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2 py-1 text-xs text-primary-600 dark:text-primary-400 rounded-md hover:bg-primary-50 dark:hover:bg-primary-900/50"
        >
      ...
      <nav className="space-y-1 overflow-y-auto flex-grow p-2">
        {users.map((user) => (
          <div
            key={user.id}
            className="w-full flex items-center px-3 py-2 text-sm font-medium rounded-lg text-gray-700 dark:text-gray-300"
          >
