  ...
  return (
    <div className="flex-1 flex flex-col h-full md:h-screen">
      <header className="flex items-center p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 z-10 flex-shrink-0">
        {onToggleSidebar && (
          <button
            ...
            className="md:hidden p-2 mr-2 text-gray-500 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 dark:text-gray-400"
          >
      ...
      {pinnedMessages.length > 0 && (
        <PinnedMessagesBar messages={pinnedMessages} onUnpin={togglePinMessage} />
      )}
